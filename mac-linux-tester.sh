...
diff -c tests/01_generated_output.txt 01_PushPopEmptySize_output.txt

echo "Running test 2"
g++ -pedantic -Wall -Wextra -std=c++17 -o 02_FirstLast.out 02_FirstLast.cpp
./02_FirstLast.out > tests/02_generated_output.txt
diff -c tests/02_generated_output.txt 02_FirstLast_output.txt
...
diff -c tests/03_generated_output.txt 03_ClearContains_output.txt
...
diff -c tests/04_generated_output.txt 04_CompareOperators_output.txt
...
diff -c tests/10_generated_output.txt 10_ListOfLists_output.txt
